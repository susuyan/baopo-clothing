      ...
      <div className="md:hidden">
        ...
        <div className="px-4 pt-4 pb-32">
          <div className="flex items-center gap-2 mb-3">
            <span className="px-2 py-0.5 bg-rose-50 text-rose-600 text-xs font-medium rounded">
          ...
          <h1 className="text-lg font-semibold text-gray-900 leading-snug mt-2">
            {product.title}
          </h1>
          ...
          <a
            ...
            className="mt-3 flex items-center justify-center gap-1.5 w-full py-3 text-sm text-gray-500 border border-gray-200 rounded-xl active:bg-gray-50"
          >
        ...
        <div className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-100 px-4 py-3 safe-area-pb">
          <div className="flex items-center gap-2">
            <div className="flex-1">
              <p className="text-xs text-gray-400">批发价</p>
        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="space-y-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 px-8 py-3.5 bg-rose-600 hover:bg-rose-700 text-white font-medium rounded-xl transition-colors"
            >
              <Phone className="w-4 h-4" />
              联系供应商采购
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 px-8 py-3.5 bg-white border border-gray-200 text-gray-700 font-medium rounded-xl hover:bg-gray-50 transition-colors"
            >
